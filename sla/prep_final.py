...
class PreProcessor:
    ...
    def __init__(
        ...
        self.row_filter = ee.Filter.gt('WRS_PATH', 232) # INCLUIDO PARA OBVIAR CIERTAS LANDSAT
        self.dem = dem
    ...
    def execute(self):
        ...
        collection = (
            self.l8_filtered.merge(self.s2_filtered)
        )
    ...
    def filter_l8(self):
        ...
        return (
            ...
            #.map(lambda image: image.select(self.l8_bands).reproject('EPSG:32720'))  ####
           ...
           # .map(lambda image: image.clip(self.geometry_buffered))
